...
import Page0 from "./FormComponents/Explore";
import Page1 from "./FormComponents/Parent";
import Page2 from "./FormComponents/Name.jsx";
import Page5 from "./FormComponents/CheckOut";
import Page01 from "./FormComponents/CourseSelection";
import Page4 from "./FormComponents/FreqDateTimeSelection.js";
...
import { useAllCourses } from "../hooks/useAllCourses.jsx";
...
export default function FormPage(props) {
  ...
  const { fetchCourseById } = useAllCourses();
  ...
  const pages = [
    {
      name: "Page 0",
      component: <Page0 next={nextPage} selectedLocale={selectedLocale} />,
      progress: 0,
    },
    {
      name: "Page 01",
  ...
  useEffect(() => {
    if (router.query.courseSelected) {
      fetchCourseById(router.query.courseSelected).then((course) => {
        console.log(course);
        state.getState().actions.setStudentRecommendation([course]);
        nextPage();
      });
    }
          ...
          <div className="flex items-center">
            <div className="w-full lg:h-full  lg:mb-0 mb-10">
              ...
              <FormContext.Provider
                value={{ nextPage, prevPage, selectedLocale }}
              >
