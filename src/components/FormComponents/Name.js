...
export default function NamePage(props) {
  ...
  const handleNext = async (data) => {
    data.Students = data.Students.map((student) => {
      if (student.Interest === "") {
        const { Interest, ...studentWithoutInterest } = student;
        return studentWithoutInterest;
      }
      return student;
    });
    setUserInfo(data);
                ...
                <div className="flex flex-col w-full lg:w-auto">
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      // Update the showInterest state instead of the userInfo state
                      setShowInterest(
